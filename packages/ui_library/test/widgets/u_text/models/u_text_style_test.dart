...
void main() {
  ...
  given('H2_secondaryHeader UTextStyles - text style\'s values', () {
    then(
        'H2_secondaryHeader fontFamily should be correct',
        () =>
            UTextStyle.H2_secondaryHeader.style.fontFamily.should.be('Poppins'),
        and: {
  ...
  given('H3_tertiaryHeader UTextStyles - text style\'s values', () {
    then(
        'H3_tertiaryHeader fontFamily should be correct',
        () => UTextStyle.H3_tertiaryHeader.style.fontFamily.should
            .be('SpaceMono'),
        and: {
  ...
  given('H4_fourthHeader UTextStyles - text style\'s values', () {
    then(
        'H4_fourthHeader fontFamily should be correct',
        () =>
            UTextStyle.H4_fourthHeader.style.fontFamily.should.be('SpaceMono'),
        and: {
  ...
  given('H5_fifthHeader UTextStyles - text style\'s values', () {
    then('H5_fifthHeader fontFamily should be correct',
  ...
  given('B1_body UTextStyles - text style\'s values', () {
    then('B1_body fontFamily should be correct',
  ...
  given('B2_medium UTextStyles - text style\'s values', () {
    then('B2_medium fontFamily should be correct',
  ...
  given('B3_bold UTextStyles - text style\'s values', () {
    then('B3_bold fontFamily should be correct',
  ...
  given('B4_italics UTextStyles - text style\'s values', () {
    then('B4_italics fontFamily should be correct',
  ...
  given('M1_micro UTextStyles - text style\'s values', () {
    then('M1_micro fontFamily should be correct',
  ...
  given('BUT1_primaryButton UTextStyles - text style\'s values', () {
    then(
        'BUT1_primaryButton fontFamily should be correct',
        () =>
            UTextStyle.BUT1_primaryButton.style.fontFamily.should.be('Poppins'),
        and: {
  ...
  given('BUT2_secondaryButton UTextStyles - text style\'s values', () {
    then(
        'BUT2_secondaryButton fontFamily should be correct',
        () => UTextStyle.BUT2_secondaryButton.style.fontFamily.should
            .be('Poppins'),
        and: {
