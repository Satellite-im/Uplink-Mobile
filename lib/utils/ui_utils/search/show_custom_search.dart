...
// ignore_for_file: prefer_asserts_with_message, omit_local_variable_types, lines_longer_than_80_chars, cascade_invocations, unnecessary_null_comparison, deprecated_member_use

import 'package:flutter/material.dart';
import 'package:ui_library/ui_library_export.dart';

///This file is copied from [showSearch] in Flutter
///
///showSearch->showCustomSearch,SearchDelegate->SearchCustomDelegate
///
///With the Customized TextField Style
Future<T?> showCustomSearch<T>({
  required BuildContext context,
  required SearchCustomDelegate<T> delegate,
  String? query = '',
...
/// query text field can be customized via [SearchCustomDelegate.buildLeading]
/// and [SearchCustomDelegate.buildActions]. Additionally, a widget can be placed
/// across the bottom of the [AppBar] via [SearchCustomDelegate.buildBottom].
///
/// The body below the [AppBar] can either show suggested queries (returned by
/// [SearchCustomDelegate.buildSuggestions]) or - once the user submits a search  - the
/// results of the search as returned by [SearchCustomDelegate.buildResults].
///
/// [SearchCustomDelegate.query] always contains the current query entered by the user
/// and should be used to build the suggestions and results.
///
/// The results can be brought on screen by calling [SearchCustomDelegate.showResults]
/// and you can go back to showing the suggestions by calling
/// [SearchCustomDelegate.showSuggestions].
///
/// Once the user has selected a search result, [SearchCustomDelegate.close] should be
...
///
/// A given [SearchCustomDelegate] can only be associated with one active [showCustomSearch]
/// call. Call [SearchCustomDelegate.close] before re-using the same delegate instance
/// for another [showCustomSearch] call.
///
/// ## Handling emojis and other complex characters
/// {@macro flutter.widgets.EditableText.onChanged}
abstract class SearchCustomDelegate<T> {
  ...
  /// {@tool snippet}
  /// ```dart
  /// class CustomSearchHintDelegate extends SearchCustomDelegate<String> {
...
enum _SearchBody {
  ...
  ///
  /// The suggested queries are generated by [SearchCustomDelegate.buildSuggestions].
  suggestions,

  /// Search results are currently shown in the body.
  ///
  /// The search results are generated by [SearchCustomDelegate.buildResults].
  results,
}
...
class _SearchPageRoute<T> extends PageRoute<T> {
  _SearchPageRoute({
    ...
    assert(
      ...
      'search. Please close that search by calling close() on the SearchCustomDelegate '
      'before opening another search with the same delegate instance.',
    );
    delegate._route = this;
  }

  final SearchCustomDelegate<T> delegate;
      ...
      child: Theme(
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            leadingWidth: 56,
            //Customized TextField decoration
            titleSpacing: 0,
            title: SizedBox(
              height: 40,
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  //add clear IconButton when user start typing(has focus node)
